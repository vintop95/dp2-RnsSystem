...
public interface VehClient {
	 ...
	 * @throws 500 ServiceException if the operation cannot be completed because the RNS service is not reachable or not working
	 * @throws 409 UnknownPlaceException if the source or the destination is not a known place
	 ...
	 * @throws 500 ServiceException if the operation cannot be completed because the RNS service is not reachable or not working
	 * @throws 409 UnknownPlaceException if newPlace is not the id of a known place
	 * @throws 409 WrongPlaceException if newPlace is not is not the id of a place reachable from the previous position of the vehicle
	 */
	 ...
	 * @throws 500 ServiceException if the operation cannot be completed because the RNS service is not reachable or not working
	 * @throws 409 UnknownPlaceException if outGate is not the id of a known place
	 * @throws 409 WrongPlaceException if outGate is not the id of an OUT or INOUT gate or
	 * 							   is not reachable from the previous position of the vehicle
	 */
